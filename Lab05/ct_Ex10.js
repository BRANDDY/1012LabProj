...
function reverseSame() {
    ...
    var b = 0;
    var num = a;
    outputObj.innerHTML = outputObj.innerHTML + "number: " + num;
    while (a > 0) {
        b = a % 10 + b * 10;
        a = Math.floor(a / 10);
    }
    if (num == b) {
        outputObj.innerHTML = outputObj.innerHTML + " <br><br>" + "equal to its reverse? yes";
    } else {
        outputObj.innerHTML = outputObj.innerHTML + " <br><br>" + "equal to its reverse? no";
